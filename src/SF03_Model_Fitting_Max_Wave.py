...
plt.tight_layout()
# plt.savefig('../results/SI_Fig03_Model_Fitting_Max_Wave_{}.png',dpi=300.format(flow_setting))   
plt.savefig('../results/SI_Fig03_Model_Fitting_Max_Wave_{}.pdf'.format(flow_setting)) 
